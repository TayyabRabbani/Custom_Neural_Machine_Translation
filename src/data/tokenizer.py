...
class BPETokenizerTrainer:
    def __init__(self, vocab_size=10000, save_path="artifacts/tokenizer.json"):
    ...
    def train(self, train_pairs):
        ...
        trainer = BpeTrainer(
            vocab_size=self.vocab_size, special_tokens=self.special_tokens
        )
        ...
        tokenizer.save(str(self.save_path))
    ...
    def test_tokenizer(self, tokenizer):
        ...
        sentence = "Eu gosto de estudar " "aprendizado profundo."
...
if __name__ == "__main__":
    ...
    tokenizer = trainer.train(train_pairs)
